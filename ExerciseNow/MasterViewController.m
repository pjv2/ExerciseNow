...
- (void)insertNewObject:(id)sender
{
    ...
    [_exercises insertObject:[NSDate date] atIndex:0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExerciseNowDoc *exercise = [self.exercises objectAtIndex:indexPath.row];
    cell.textLabel.text = exercise.data.title;
    cell.imageView.image = exercise.thumbImage;
    return cell;
}
